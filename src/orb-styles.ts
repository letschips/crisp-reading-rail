...
export const ORB_STYLE_OPTIONS: ReadonlyArray<{
  ...
  { value: "character6", label: "Character 6 (Labubu Chucky)" },
  { value: "character7", label: "Character 7 (Hello Kitty)" },
  { value: "character8", label: "Character 8 (Stitch)" },
  { value: "character9", label: "Character 9 (Labubu)" },
  { value: "character10", label: "Character 10 (Grey Labubu)" },
